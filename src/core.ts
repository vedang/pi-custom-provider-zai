...
interface ZaiProviderConfigInput {
...
const GLM_5_1_ZAI_MODEL: ZaiModelTemplate = {
  ...SHARED_MODEL_DEFAULTS,
  provider: "zai",
  id: "glm-5.1",
  name: "GLM-5.1 (ZAI)",
 ...
 */
function resolveZaiRuntimeSettings(
  env: Record<string, string | undefined> = process.env,
  options?: ZaiSimpleOptions,
): ZaiRuntimeSettings {
  // [tag:generic_temperature_env_contract] - Generic temperature from subagent
